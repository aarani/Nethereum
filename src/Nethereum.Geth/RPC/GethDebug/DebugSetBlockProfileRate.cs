...
namespace Nethereum.Geth.RPC.Debug
{
    ...
    /// </Summary>
    public class DebugSetBlockProfileRate : RpcRequestResponseHandler<object>, IDebugSetBlockProfileRate
    {
        ...
        {
            return base.SendRequestAsync(id, cancellationToken, rate);
        }
    }
}