...
{
    /// <Summary>
    ///     The startHTTP administrative method starts an HTTP based JSON RPC API webserver to handle client requests. All the
    ...
    /// </Summary>
    public class AdminStartHTTP : RpcRequestResponseHandler<bool>, IAdminStartHTTP
    {
        public AdminStartHTTP(IClient client) : base(client, ApiMethods.admin_startHTTP.ToString())
        {
        }
        ...
        public Task<bool> SendRequestAsync(string host, int port, string cors, string api, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.SendRequestAsync(id, cancellationToken, host, port, cors, api);
        }

        public Task<bool> SendRequestAsync(string host, int port, string cors, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.SendRequestAsync(id, cancellationToken, host, port, cors);
        }

        public Task<bool> SendRequestAsync(string host, int port, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.SendRequestAsync(id, cancellationToken, host, port);
        }

        public Task<bool> SendRequestAsync(string host, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.SendRequestAsync(id, cancellationToken, host);
        }

        public Task<bool> SendRequestAsync(object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
