...
namespace Nethereum.RPC.Eth.Transactions
{
    public interface IEthFeeHistory
    {
        ...
        /// <returns></returns>
        Task<FeeHistoryResult> SendRequestAsync(HexBigInteger blockCount, BlockParameter highestBlockNumber, decimal[] rewardPercentiles = null, object id = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// Floating point value between 0 and 100.</param>
        /// <returns></returns>
        RpcRequest BuildRequest(HexBigInteger blockCount, BlockParameter highestBlockNumber, decimal[] rewardPercentiles = null, object id = null);
    }
}