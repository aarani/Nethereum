...
namespace Nethereum.RPC.Eth.Uncles
{
    ...
    ///     }
    /// </Summary>
    public class EthGetUncleCountByBlockHash : RpcRequestResponseHandler<HexBigInteger>, IEthGetUncleCountByBlockHash
    {
        ...
        public Task<HexBigInteger> SendRequestAsync(string hash,
                                                    object id = null,
