...
#if !DOTNET35
        Task<string> SendRequestAsync(SwitchEthereumChainParameter switchEthereumChainParameter, object id = null, CancellationToken cancellationToken = default(CancellationToken));
#endif
    }
...
#if !DOTNET35
        public async Task<string> SendRequestAsync(SwitchEthereumChainParameter switchEthereumChainParameter, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            await base.SendRequestAsync(id, cancellationToken, switchEthereumChainParameter);
