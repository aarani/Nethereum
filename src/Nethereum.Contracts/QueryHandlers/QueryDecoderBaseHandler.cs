...
namespace Nethereum.Contracts.QueryHandlers
{
        ...
        where TFunctionMessage : FunctionMessage, new()
    {
        ...
        public async Task<TFunctionOutput> QueryAsync(string contractAddress,
                                                      TFunctionMessage functionMessage = null,
                                                      BlockParameter block = null,
                                                      CancellationToken cancellationToken = default(CancellationToken))
        {
            var result = await QueryRawHandler.QueryAsync(contractAddress, functionMessage, block, cancellationToken)
