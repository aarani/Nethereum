...
namespace Nethereum.Quorum.RPC.Raft
{
    ...
    {
        Task<bool> SendRequestAsync(string raftId, object id = null, CancellationToken cancellationToken = default(CancellationToken));
...
/// result: boolean - indicates if the node is promoted    
    ...
    public class RaftPromoteToPeer : RpcRequestResponseHandler<bool>, IRaftPromoteToPeer
    {
            ...
            public Task<bool> SendRequestAsync(string raftId, object id = null, CancellationToken cancellationToken = default(CancellationToken))
            {
