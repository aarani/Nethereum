...
namespace Nethereum.Quorum.RPC.Permission
{
    ...
    ///</Summary>
    public interface IQuorumPermissionApproveBlackListedNodeRecovery
    {
        Task<string> SendRequestAsync(string orgId, string enodeId, object id = null, CancellationToken cancellationToken = default(CancellationToken));
...
/// result: string - response message    
///</Summary>
    public class QuorumPermissionApproveBlackListedNodeRecovery : RpcRequestResponseHandler<string>, IQuorumPermissionApproveBlackListedNodeRecovery
    {
        ...
        public Task<string> SendRequestAsync(string orgId, string enodeId, object id = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return base.SendRequestAsync(id, cancellationToken, orgId, enodeId);
        }
